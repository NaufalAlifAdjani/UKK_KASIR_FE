...
export default class HitoryTransaksi extends React.Component {
  ...
  handleSave = (e) => {
    ...
    if (this.state.action === "insert") {
      ...
      let url = "http://localhost:8000/transaksi/update/" + this.state.id_transaksi;
      axios
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
              ...
              <div class="px-6 py-6 lg:px-8">
                ...
                <div>
                      ...
                      <input type="text" name="nama_pelanggan" id="nama_pelanggan" value={this.state.nama_pelanggan} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan nama_pelanggan user" required />
                  </div>
                  <div>
                      <label for="id_meja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">id_meja</label>
                      <input type="text" name="id_meja" id="id_meja" value={this.state.id_meja} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan id_meja user" required />
                  </div>
                  <div>
                      <label for="id_user" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">id_user</label>
                      <input type="text" name="id_user" id="id_user" value={this.state.id_user} onChange={this.handleChange} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-gray-800 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-800" placeholder="Masukkan id_user user" required />
                  </div>
                  <div>
