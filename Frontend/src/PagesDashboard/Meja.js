...
export default class Meja extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            ...
            let url = "http://localhost:8000/meja/update/" + this.state.id_meja
    ...
    handleDrop = (id) => {
        let url = "http://localhost:8000/meja/delete/" + id
    ...
    // getmeja = () => {
    //     let url = "http://localhost:8080/meja-type"
    //     axios.get(url)
    //         .then(response => {
    //             this.setState({
    //                 meja: response.data.data
            ...
            <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
                ...
                <main class="main flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
                    ...
                    <div class="main-content flex flex-col flex-grow p-4">
                        ...
                        <p class="text-gray-700">For meja in Hotel Slippy</p>
