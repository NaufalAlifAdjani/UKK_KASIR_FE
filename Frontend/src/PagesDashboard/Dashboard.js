  ...
  <div class="grid gap-10 lg:grid-cols-2">
    <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
      <div class="max-w-xl mb-6">
        ...
        Welcome to SCOFF caffee, where luxury meets tranquility. Nestled in a picturesque location, our hotel offers a serene and enchanting ambiance, making it the perfect destination for both leisure and business travelers.
        </p>
      </div>
      <div>
      </div>
